...
function AccountDetailModal({ account, onClose, onUpdate, groups = [] }) {
    ...
    const handleSave = async () => {
        ...
        const payloadToSave = {
            ...
            purchase_date: (editedAccount.purchaseDate && String(editedAccount.purchaseDate).trim()) ? editedAccount.purchaseDate : null,
            ...
            as_on_date: (editedAccount.asOnDate && String(editedAccount.asOnDate).trim()) ? editedAccount.asOnDate : null,
