...
import { accountGroups, primaryCOAGroups } from '@/lib/data/accountingData';
import { checkDuplicateName, getGroupPath } from '@/lib/utils/accountHelpers';

function GroupCreationModal({ onClose, onSave }) {
    ...
    const handleNameChange = (name) => {
        ...
        if (name.trim()) {
            const duplicate = checkDuplicateName(name, accountGroups);
    ...
    const handleSubmit = (e) => {
        ...
        const newGroup = {
            ...
            nature: accountGroups.find(g => g.id === formData.under)?.nature || 'asset',
