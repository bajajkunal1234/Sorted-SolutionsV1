...
import { getStockStatus, getStockStatusColor, getStockStatusLabel, formatStock } from '../../utils/inventoryHelpers';
import { productCategories } from '../../data/inventoryData';

function InventoryTableView({ products, onProductClick }) {
