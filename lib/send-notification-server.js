...
const CHANNEL_MAP = {
    'default': 'jobs_v3',
    'jobs': 'jobs_v3',
    'alerta_breaking_bad': 'alerta_breaking_bad_v3',
    'complete': 'complete_v3',
    'lg_woodpecker': 'lg_woodpecker_v3',
    'milomilo': 'milomilo_v3',
    'money': 'money_v3'
};
 ...
 */
export async function sendFCMPush(token, { title, body, data = {}, sound }) {
    ...
    const targetChannel = CHANNEL_MAP[sound] || CHANNEL_MAP['default'];
 ...
 * @param {{ title: string, body: string, data?: Record<string, string> }} payload
 */
export async function sendFCMMulticast(tokens, { title, body, data = {}, sound }) {
