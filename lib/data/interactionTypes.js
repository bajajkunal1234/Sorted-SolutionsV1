...
export const interactionTypes = {
    ...
    'cx-denied-service': {
        label: 'Customer Denied Service',
        category: 'job',
        icon: '🙅',
        description: 'Customer denied service request'
    },
    ...
    'technician-login': {
        ...
        category: 'account',
        icon: '🔐',
        description: 'Technician logged into portal'
    },
    'appliance-created': {
        label: 'Appliance Added',
        category: 'account',
        icon: '📦',
        description: 'New appliance registered by customer'
    },
    'nav-tab-switch': {
        label: 'App Navigation',
        category: 'navigation',
        icon: '🔄',
        description: 'User switched between app tabs'
    },
    'call-customer': {
        label: 'Called Customer',
        category: 'communication',
        icon: '📞',
        description: 'Technician initiated call to customer'
    },
    'homepage-service-click': {
        label: 'Homepage Lead Click',
        category: 'acquisition',
        icon: '🖱️',
        description: 'User clicked service category on homepage'
    }
};
