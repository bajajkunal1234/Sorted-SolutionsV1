...
export const categoryGroups = [
    ...
    {
        id: 'leads-tracker',
        label: '🎯 Google Ads Leads & ROI Tracker',
        description: 'Track campaign spending, manual and organic leads, conversions, and advertising return on investment (ROI)',
        color: '#10b981',
        hasAddNew: false
    }
];
...
export const staticSettingsByCategory = {
    homepage: [
        ...
        },
        {
            ...
            icon: ImageIcon,
            description: 'Manage the brand logos auto-scrolling marquee section on the homepage',
            color: '#8b5cf6'
        }
    ],
    ...
    global: [
        {
            ...
            icon: Award,
            description: 'Edit the "Why Choose Us" section shown across all pages (homepage, service pages, location pages)',
            color: '#ec4899'
        },
        {
            id: 'how-it-works',
            ...
            icon: CheckCircle,
            description: 'Edit the "How It Works" steps shown across all pages (homepage, service pages, location pages)',
            color: '#06b6d4'
        },
        {
            id: 'faqs',
