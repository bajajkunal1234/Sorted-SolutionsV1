import { Wind, Snowflake, Waves, Droplets, Flame, FlameKindling, MapPin, CheckCircle, Award, MessageCircle, Clock, Calendar, UserPlus, Image as ImageIcon, Map, Star, Building2, FileText } from 'lucide-react';
...
export const settingsByCategory = {
    ...
    global: [
        ...
        {
            id: 'brand-logos',
            label: 'Brand Logos Management',
            icon: ImageIcon,
            description: 'Manage brand logos displayed in various sections',
            color: '#8b5cf6'
        },
        {
            id: 'static-pages',
