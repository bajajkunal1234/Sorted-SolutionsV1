...
export const amcPlansAPI = {
    getAll: async (filters = {}) => {
        ...
        const query = params.toString() ? `?${params.toString()}` : ''
        return apiFetch(`/amc-plans${query}`)
    },

    create: async (planData) => {
        return apiFetch('/amc-plans', {
            method: 'POST',
    ...
    delete: async (id) => {
        return apiFetch(`/amc-plans?id=${id}`, {
            method: 'DELETE',
        })
    },
}
...
export const rentalPlansAPI = {
    getAll: async (filters = {}) => {
        ...
        const query = params.toString() ? `?${params.toString()}` : ''
        return apiFetch(`/rental-plans${query}`)
    },

    create: async (planData) => {
        return apiFetch('/rental-plans', {
            method: 'POST',
            body: JSON.stringify(planData),
        })
    },
    ...
    delete: async (id) => {
        return apiFetch(`/rental-plans?id=${id}`, {
            method: 'DELETE',
        })
    },
}
...
export default {
    ...
    amcPlans: amcPlansAPI,
    rentalPlans: rentalPlansAPI,
